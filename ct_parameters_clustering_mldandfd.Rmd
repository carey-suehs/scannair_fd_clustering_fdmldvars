---
title: "Perform and display clustering for computed tomography MLD+FD profiles"
...
write.csv(c1_descriptives, file = "C:/Users/csuehs/Dropbox/SCANN'AIR_fractal_dimension/Submission2_Investigative_Radiology/stats-tables/fdmldclusters_c1_descriptives.csv")
write.csv2(c1_descriptives, file = "C:/Users/csuehs/Dropbox/SCANN'AIR_fractal_dimension/Submission2_Investigative_Radiology/stats-tables/fdmldclusters_c1_descriptives_csv2.csv")
...
write.csv(c2_descriptives, file = "C:/Users/csuehs/Dropbox/SCANN'AIR_fractal_dimension/Submission2_Investigative_Radiology/stats-tables/fdmldclusters_c2_descriptives.csv")
write.csv2(c2_descriptives, file = "C:/Users/csuehs/Dropbox/SCANN'AIR_fractal_dimension/Submission2_Investigative_Radiology/stats-tables/fdmldclusters_c2_descriptives_csv2.csv")
...
write.csv(two_group_comparisons_12, file = "C:/Users/csuehs/Dropbox/SCANN'AIR_fractal_dimension/Submission2_Investigative_Radiology/stats-tables/cluster_comparisons_mldfd_12.csv")
write.csv2(two_group_comparisons_12, file = "C:/Users/csuehs/Dropbox/SCANN'AIR_fractal_dimension/Submission2_Investigative_Radiology/stats-tables/cluster_comparisons_mldfd_12_csv2.csv")
...
two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_i_up"] <- 13
two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_i_lo"] <- 14

two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_e_up"] <- 16
two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_e_lo"] <- 17

two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_ei_up"] <- 19
two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_ei_lo"] <- 20

two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_i_bias"] <- 22
two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_e_bias"] <- 23
two_group_comparisons_12$rpos[two_group_comparisons_12$variable == "fd_ei_bias"] <- 24
...
petitpois <- ggplot(segment(ddata)) +
    ...
    annotate("text", x=-2.8, y=-3.5, label = "BMI~(kg/m^{2})", size=5, color="black", parse = TRUE)+
    ...
    geom_point(data = df, aes(x = x, y = -14.5, colour = q_fd_i_up), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-14.5, label = "FD['I-850_U']", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -15.5, colour = q_fd_i_lo), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-15.5, label = "FD['I-850_L']", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -17.5, colour = q_fd_e_up), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-17.5, label = "FD['E-850_U']", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -18.5, colour = q_fd_e_lo), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-18.5, label = "FD['E-850_L']", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -20.5, colour = q_fd_ei_up), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-20.5, label = "FD['E/I-850_U']", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -21.5, colour = q_fd_ei_lo), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-21.5, label = "FD['E/I-850_L']", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -23.5, colour = q_fd_i_bias), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-23.5, label = "FD['I-850_BIAS']", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -24.5, colour = q_fd_e_bias), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-24.5, label = "FD['E-850_BIAS']", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -25.5, colour = q_fd_ei_bias), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-25.5, label = "FD['E/I-850_BIAS']", size=5, color="black", parse = TRUE)+
    
    
    
    geom_point(data = df, aes(x = x, y = -27.5, colour = q_mld_i_up), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-27.5, label = "MLD[I_U]", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -28.5, colour = q_mld_i_lo), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-28.5, label = "MLD[I_L]", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -30.5, colour = q_mld_e_up), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-30.5, label = "MLD[E_U]", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -31.5, colour = q_mld_e_lo), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-31.5, label = "MLD[E_L]", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -33.5, colour = q_mld_ei_up), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-33.5, label = "MLD[E/I_U]", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -34.5, colour = q_mld_ei_lo), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-34.5, label = "MLD[E/I_L]", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -36.5, colour = q_mld_i_bias), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-36.5, label = "MLD[I_BIAS]", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -37.5, colour = q_mld_e_bias), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-37.5, label = "MLD[E_BIAS]", size=5, color="black", parse = TRUE)+
    
    geom_point(data = df, aes(x = x, y = -38.5, colour = q_mld_ei_bias), size = 7, shape = 19)+
    annotate("text", x=-2.8, y=-38.5, label = "MLD[E/I_BIAS]", size=5, color="black", parse = TRUE)+
    
    
    
    
    
    geom_segment(aes(x=10.5, y=-39, xend=10.5, yend=10), color="blue")+
  
    scale_colour_gradient(low = "green", high = "hotpink", na.value = "white")+
    
    annotate("text", x=14.5, y=-13.2, label = "~underline('Clustering variables')", size=7, color="black", hjust=0.5, parse = TRUE)+
    ...
    annotate("text", x=4.7, y=18, label = "1", size = 10, color="darkgrey")+
    annotate("text", x=16.7, y=18, label = "2", size = 10, color="darkgrey")+
...
pdf(file = "C:/Users/csuehs/Dropbox/SCANN'AIR_fractal_dimension/Submission2_Investigative_Radiology/figure_6/figure_6_drendrogram_dots_dfandmld.pdf",
    height = 20, width = 15)
